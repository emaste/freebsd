...
struct cloudabi64_sys_fd_pread_args {
	...
	cloudabi_fd_t fd;
	char fd_r_[PADR_(cloudabi_fd_t)];
	char iovs_l_[PADL_(const cloudabi64_iovec_t *)];
	const cloudabi64_iovec_t *iovs;
	char iovs_r_[PADR_(const cloudabi64_iovec_t *)];
...
struct cloudabi64_sys_fd_pwrite_args {
	...
	cloudabi_fd_t fd;
	char fd_r_[PADR_(cloudabi_fd_t)];
	char iovs_l_[PADL_(const cloudabi64_ciovec_t *)];
	const cloudabi64_ciovec_t *iovs;
	char iovs_r_[PADR_(const cloudabi64_ciovec_t *)];
	char iovs_len_l_[PADL_(size_t)];
	size_t iovs_len;
	char iovs_len_r_[PADR_(size_t)];
	char offset_l_[PADL_(cloudabi_filesize_t)];
...
struct cloudabi64_sys_poll_args {
	char in_l_[PADL_(const cloudabi64_subscription_t *)];
	const cloudabi64_subscription_t *in;
	char in_r_[PADR_(const cloudabi64_subscription_t *)];
...
struct cloudabi64_sys_sock_recv_args {
	...
	char in_l_[PADL_(const cloudabi64_recv_in_t *)];
	const cloudabi64_recv_in_t *in;
	char in_r_[PADR_(const cloudabi64_recv_in_t *)];
	char out_l_[PADL_(cloudabi64_recv_out_t *)];
	cloudabi64_recv_out_t *out;
	char out_r_[PADR_(cloudabi64_recv_out_t *)];
};
struct cloudabi64_sys_sock_send_args {
	char sock_l_[PADL_(cloudabi_fd_t)];
	cloudabi_fd_t sock;
	char sock_r_[PADR_(cloudabi_fd_t)];
	char in_l_[PADL_(const cloudabi64_send_in_t *)];
	const cloudabi64_send_in_t *in;
	char in_r_[PADR_(const cloudabi64_send_in_t *)];
	char out_l_[PADL_(cloudabi64_send_out_t *)];
	cloudabi64_send_out_t *out;
	char out_r_[PADR_(cloudabi64_send_out_t *)];
};
...
struct cloudabi64_sys_thread_create_args {
	char attr_l_[PADL_(cloudabi64_threadattr_t *)];
	cloudabi64_threadattr_t *attr;
	char attr_r_[PADR_(cloudabi64_threadattr_t *)];
};
...
int cloudabi64_sys_fd_pread(
    struct thread *, struct cloudabi64_sys_fd_pread_args *);
int cloudabi64_sys_fd_pwrite(
    struct thread *, struct cloudabi64_sys_fd_pwrite_args *);
int cloudabi64_sys_fd_read(
    struct thread *, struct cloudabi64_sys_fd_read_args *);
...
int cloudabi64_sys_fd_write(
    struct thread *, struct cloudabi64_sys_fd_write_args *);
...
int cloudabi64_sys_sock_recv(
    struct thread *, struct cloudabi64_sys_sock_recv_args *);
int cloudabi64_sys_sock_send(
...
int cloudabi64_sys_thread_create(
    struct thread *, struct cloudabi64_sys_thread_create_args *);
