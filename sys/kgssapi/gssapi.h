...
OM_uint32 gss_set_cred_option(OM_uint32 *, /* minor status */
    gss_cred_id_t *,			   /* cred */
    const gss_OID,			   /* option to set */
    const gss_buffer_t			   /* option value */
);

OM_uint32 gss_pname_to_uid(OM_uint32 *, /* minor status */
...
/*
 * On entry, *numgroups is set to the maximum number of groups to return. On
 * exit, *numgroups is set to the actual number of groups returned.
 */
OM_uint32 gss_pname_to_unix_cred(OM_uint32 *, /* minor status */
    const gss_name_t pname,		      /* principal name */
    const gss_OID mech,			      /* mechanism to query */
    uid_t *uidp,			      /* pointer to UID for result */
 ...
 */
struct mbuf;
OM_uint32 gss_get_mic_mbuf(OM_uint32 *, /* minor_status */
    const gss_ctx_id_t,			/* context_handle */
    gss_qop_t,				/* qop_req */
...
OM_uint32 gss_verify_mic_mbuf(OM_uint32 *, /* minor_status */
    const gss_ctx_id_t,			   /* context_handle */
    struct mbuf *,			   /* message_buffer */
...
OM_uint32 gss_wrap_mbuf(OM_uint32 *, /* minor_status */
    const gss_ctx_id_t,		     /* context_handle */
    int,			     /* conf_req_flag */
    gss_qop_t,			     /* qop_req */
    struct mbuf **,		     /* message_buffer */
...
OM_uint32 gss_unwrap_mbuf(OM_uint32 *, /* minor_status */
    const gss_ctx_id_t,		       /* context_handle */
    struct mbuf **,		       /* message_buffer */
    int *,			       /* conf_state */
    gss_qop_t *			       /* qop_state */
