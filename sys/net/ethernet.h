...
#define ETHERTYPE_NBPVCD                                               \
	0x3C00 /* 3Com NBP virtual circuit datagram (like XNS SPP) not \
		  registered */
...
/* 0x80DE - 0x80DF	   TRFS (Integrated Solutions Transparent Remote File
 * System) */
...
#define ETHERTYPE_XNSSM                                              \
	0x9001 /* 3Com (Formerly Bridge Communications), XNS Systems \
		  Management */
#define ETHERTYPE_TCPSM                                                 \
	0x9002 /* 3Com (Formerly Bridge Communications), TCP/IP Systems \
		  Management */
