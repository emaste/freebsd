...
enum fsh_mode { fsm_DN = 0, fsm_DR = 1, fsm_DW = 2, fsm_DRW = 3 };
typedef enum fsh_mode fsh_mode;

enum fsh_access { fsa_NONE = 0, fsa_R = 1, fsa_W = 2, fsa_RW = 3 };
...
extern enum clnt_stat nlm_sm_notify_0(struct nlm_sm_status *, void *, CLIENT *,
    struct rpc_callextra *, struct timeval);
extern bool_t nlm_sm_notify_0_svc(
    struct nlm_sm_status *, void *, struct svc_req *);
...
extern bool_t nlm_test_1_svc(
    struct nlm_testargs *, nlm_testres *, struct svc_req *);
...
extern bool_t nlm_lock_1_svc(
    struct nlm_lockargs *, nlm_res *, struct svc_req *);
...
extern bool_t nlm_cancel_1_svc(
    struct nlm_cancargs *, nlm_res *, struct svc_req *);
...
extern bool_t nlm_unlock_1_svc(
    struct nlm_unlockargs *, nlm_res *, struct svc_req *);
...
extern bool_t nlm_granted_1_svc(
    struct nlm_testargs *, nlm_res *, struct svc_req *);
...
extern bool_t nlm_test_msg_1_svc(
    struct nlm_testargs *, void *, struct svc_req *);
...
extern bool_t nlm_lock_msg_1_svc(
    struct nlm_lockargs *, void *, struct svc_req *);
...
extern bool_t nlm_cancel_msg_1_svc(
    struct nlm_cancargs *, void *, struct svc_req *);
#define NLM_UNLOCK_MSG ((unsigned long)(9))
extern enum clnt_stat nlm_unlock_msg_1(struct nlm_unlockargs *, void *,
    CLIENT *, struct rpc_callextra *, struct timeval);
extern bool_t nlm_unlock_msg_1_svc(
    struct nlm_unlockargs *, void *, struct svc_req *);
...
extern enum clnt_stat nlm_test_res_1(
    nlm_testres *, void *, CLIENT *, struct rpc_callextra *, struct timeval);
...
extern enum clnt_stat nlm_lock_res_1(
    nlm_res *, void *, CLIENT *, struct rpc_callextra *, struct timeval);
...
extern bool_t nlm_share_3_svc(
    nlm_shareargs *, nlm_shareres *, struct svc_req *);
...
extern enum clnt_stat nlm_free_all_3(
    nlm_notify *, void *, CLIENT *, struct rpc_callextra *, struct timeval);
...
extern bool_t nlm4_test_4_svc(
    nlm4_testargs *, nlm4_testres *, struct svc_req *);
...
extern bool_t nlm4_unlock_4_svc(
    nlm4_unlockargs *, nlm4_res *, struct svc_req *);
...
extern enum clnt_stat nlm4_test_msg_4(
    nlm4_testargs *, void *, CLIENT *, struct rpc_callextra *, struct timeval);
...
extern enum clnt_stat nlm4_lock_msg_4(
    nlm4_lockargs *, void *, CLIENT *, struct rpc_callextra *, struct timeval);
...
extern enum clnt_stat nlm4_cancel_msg_4(
    nlm4_cancargs *, void *, CLIENT *, struct rpc_callextra *, struct timeval);
...
extern bool_t nlm4_unlock_msg_4_svc(
    nlm4_unlockargs *, void *, struct svc_req *);
...
extern enum clnt_stat nlm4_test_res_4(
    nlm4_testres *, void *, CLIENT *, struct rpc_callextra *, struct timeval);
...
extern enum clnt_stat nlm4_lock_res_4(
    nlm4_res *, void *, CLIENT *, struct rpc_callextra *, struct timeval);
...
extern bool_t nlm4_share_4_svc(
    nlm4_shareargs *, nlm4_shareres *, struct svc_req *);
#define NLM4_UNSHARE ((unsigned long)(21))
extern enum clnt_stat nlm4_unshare_4(nlm4_shareargs *, nlm4_shareres *,
    CLIENT *, struct rpc_callextra *, struct timeval);
...
extern enum clnt_stat nlm4_free_all_4(
    nlm4_notify *, void *, CLIENT *, struct rpc_callextra *, struct timeval);
