...
void _iwl_mvm_mac_itxq_xmit(struct ieee80211_hw *hw, struct ieee80211_txq *txq, const char *, int);
#define	iwl_mvm_mac_itxq_xmit(_hw, _txq)	_iwl_mvm_mac_itxq_xmit(_hw, _txq, __func__, __LINE__)
