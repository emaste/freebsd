...
struct linux_madvise_args {
	...
	l_size_t len;
	char len_r_[PADR_(l_size_t)];
	char behav_l_[PADL_(l_int)];
	l_int behav;
	char behav_r_[PADR_(l_int)];
};
...
struct linux_sendfile_args {
	...
	char offset_l_[PADL_(l_off_t *)];
	l_off_t *offset;
	char offset_r_[PADR_(l_off_t *)];
...
struct linux_exit_args {
	char rval_l_[PADL_(l_int)];
	l_int rval;
	char rval_r_[PADR_(l_int)];
};
...
struct linux_semop_args {
	...
	char tsops_l_[PADL_(struct l_sembuf *)];
	struct l_sembuf *tsops;
	char tsops_r_[PADR_(struct l_sembuf *)];
	char nsops_l_[PADL_(l_uint)];
	l_uint nsops;
	char nsops_r_[PADR_(l_uint)];
};
...
struct linux_truncate_args {
	...
	char *path;
	char path_r_[PADR_(char *)];
	char length_l_[PADL_(l_long)];
	l_long length;
	char length_r_[PADR_(l_long)];
};
...
struct linux_ptrace_args {
	...
	l_ulong addr;
	char addr_r_[PADR_(l_ulong)];
	char data_l_[PADL_(l_ulong)];
	l_ulong data;
	char data_r_[PADR_(l_ulong)];
};
...
struct linux_getpriority_args {
	...
	l_int which;
	char which_r_[PADR_(l_int)];
	char who_l_[PADL_(l_int)];
	l_int who;
	char who_r_[PADR_(l_int)];
};
...
struct linux_prctl_args {
	...
	l_int option;
	char option_r_[PADR_(l_int)];
	char arg2_l_[PADL_(l_uintptr_t)];
	l_uintptr_t arg2;
	char arg2_r_[PADR_(l_uintptr_t)];
	char arg3_l_[PADL_(l_uintptr_t)];
	l_uintptr_t arg3;
	char arg3_r_[PADR_(l_uintptr_t)];
	char arg4_l_[PADL_(l_uintptr_t)];
	l_uintptr_t arg4;
	char arg4_r_[PADR_(l_uintptr_t)];
	char arg5_l_[PADL_(l_uintptr_t)];
	l_uintptr_t arg5;
	char arg5_r_[PADR_(l_uintptr_t)];
};
struct linux_arch_prctl_args {
	char code_l_[PADL_(l_int)];
	l_int code;
	char code_r_[PADR_(l_int)];
	char addr_l_[PADL_(l_ulong)];
	l_ulong addr;
	char addr_r_[PADR_(l_ulong)];
};
...
struct linux_iopl_args {
	char level_l_[PADL_(l_uint)];
	l_uint level;
	char level_r_[PADR_(l_uint)];
};
...
struct linux_sys_futex_args {
	...
	char val_l_[PADL_(l_int)];
	l_int val;
	char val_r_[PADR_(l_int)];
	...
	char val3_l_[PADL_(l_int)];
	l_int val3;
	char val3_r_[PADR_(l_int)];
};
...
struct linux_set_tid_address_args {
	char tidptr_l_[PADL_(l_int *)];
	l_int *tidptr;
	char tidptr_r_[PADR_(l_int *)];
};
...
struct linux_fadvise64_args {
	...
	l_size_t len;
	char len_r_[PADR_(l_size_t)];
	char advice_l_[PADL_(l_int)];
	l_int advice;
	char advice_r_[PADR_(l_int)];
};
...
struct linux_exit_group_args {
	char error_code_l_[PADL_(l_int)];
	l_int error_code;
	char error_code_r_[PADR_(l_int)];
};
...
struct linux_waitid_args {
	char idtype_l_[PADL_(l_int)];
	l_int idtype;
	char idtype_r_[PADR_(l_int)];
...
struct linux_ppoll_args {
	...
	char nfds_l_[PADL_(l_uint)];
	l_uint nfds;
	char nfds_r_[PADR_(l_uint)];
	char tsp_l_[PADL_(struct l_timespec *)];
	struct l_timespec *tsp;
	char tsp_r_[PADR_(struct l_timespec *)];
...
struct linux_dup3_args {
	char oldfd_l_[PADL_(l_uint)];
	l_uint oldfd;
	char oldfd_r_[PADR_(l_uint)];
	char newfd_l_[PADL_(l_uint)];
	l_uint newfd;
	char newfd_r_[PADR_(l_uint)];
	char flags_l_[PADL_(l_int)];
	l_int flags;
	char flags_r_[PADR_(l_int)];
};
...
struct linux_setns_args {
	...
	l_int fd;
	char fd_r_[PADR_(l_int)];
	char nstype_l_[PADL_(l_int)];
	l_int nstype;
	char nstype_r_[PADR_(l_int)];
};
...
struct linux_kexec_file_load_args {
	char kernel_fd_l_[PADL_(l_int)];
	l_int kernel_fd;
	char kernel_fd_r_[PADR_(l_int)];
	char initrd_fd_l_[PADL_(l_int)];
	l_int initrd_fd;
	char initrd_fd_r_[PADR_(l_int)];
	char cmdline_len_l_[PADL_(l_ulong)];
	l_ulong cmdline_len;
	char cmdline_len_r_[PADR_(l_ulong)];
	char cmdline_ptr_l_[PADL_(const char *)];
	const char *cmdline_ptr;
	char cmdline_ptr_r_[PADR_(const char *)];
	char flags_l_[PADL_(l_ulong)];
	l_ulong flags;
	char flags_r_[PADR_(l_ulong)];
};
