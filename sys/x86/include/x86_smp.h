...
/* IPI handlers */
inthand_t IDTVEC(ipi_intr_bitmap_handler), /* Bitmap based IPIs */
    IDTVEC(ipi_swi),			   /* Runs delayed SWI */
    IDTVEC(cpustop),	/* CPU stops & waits to be restarted */
    IDTVEC(cpususpend), /* CPU suspends & waits to be resumed */
    IDTVEC(rendezvous); /* handle CPU rendezvous */

typedef void (*smp_invl_cb_t)(
    struct pmap *, vm_offset_t addr1, vm_offset_t addr2);
...
void smp_masked_invltlb(
    cpuset_t mask, struct pmap *pmap, smp_invl_cb_t curcpu_cb);
