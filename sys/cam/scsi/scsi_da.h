...
#define SRDDH10_MAX_LENGTH \
	SRDD10_MAX_LENGTH - sizeof(struct scsi_read_defect_data_hdr_10)
};
...
#define SRDDH12_MAX_LENGTH \
	SRDD12_MAX_LENGTH - sizeof(struct scsi_read_defect_data_hdr_12)
};
...
#define SMS_RIGID_GEOMETRY_PLEN 0x16
		...
		u_int8_t reserved19;
		u_int8_t
		    medium_rot_rate_1; /* medium rotation rate (RPM) (MSB) */
		u_int8_t
		    medium_rot_rate_0; /* medium rotation rate (RPM) (LSB) */
		u_int8_t reserved22;
		u_int8_t reserved23;
	} rigid_geometry;
