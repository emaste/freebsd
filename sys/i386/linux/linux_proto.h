...
struct linux_execve_args {
	...
	char *path;
	char path_r_[PADR_(char *)];
	char argp_l_[PADL_(char **)];
	char **argp;
	char argp_r_[PADR_(char **)];
...
struct linux_signal_args {
	...
	char handler_l_[PADL_(void *)];
	void *handler;
	char handler_r_[PADR_(void *)];
};
...
struct linux_ioctl_args {
	...
	char arg_l_[PADL_(l_ulong)];
	l_ulong arg;
	char arg_r_[PADR_(l_ulong)];
};
...
struct linux_lstat_args {
	...
	char *path;
	char path_r_[PADR_(char *)];
	char up_l_[PADL_(struct l_stat *)];
	struct l_stat *up;
	char up_r_[PADR_(struct l_stat *)];
};
...
struct linux_uselib_args {
	char library_l_[PADL_(char *)];
	char *library;
	char library_r_[PADR_(char *)];
};
...
struct linux_modify_ldt_args {
	char func_l_[PADL_(l_int)];
	l_int func;
	char func_r_[PADR_(l_int)];
	char ptr_l_[PADL_(void *)];
	void *ptr;
	char ptr_r_[PADR_(void *)];
	char bytecount_l_[PADL_(l_ulong)];
	l_ulong bytecount;
	char bytecount_r_[PADR_(l_ulong)];
};
...
struct linux_truncate64_args {
	...
	char *path;
	char path_r_[PADR_(char *)];
	char length_l_[PADL_(l_loff_t)];
	l_loff_t length;
	char length_r_[PADR_(l_loff_t)];
};
...
struct linux_fadvise64_64_args {
	...
	l_loff_t offset;
	char offset_r_[PADR_(l_loff_t)];
	char len_l_[PADL_(l_loff_t)];
	l_loff_t len;
	char len_r_[PADR_(l_loff_t)];
	char advice_l_[PADL_(int)];
	int advice;
	char advice_r_[PADR_(int)];
};
...
struct linux_sync_file_range_args {
	...
	l_loff_t offset;
	char offset_r_[PADR_(l_loff_t)];
	char nbytes_l_[PADL_(l_loff_t)];
	l_loff_t nbytes;
	char nbytes_r_[PADR_(l_loff_t)];
