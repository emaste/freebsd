...
struct linux_personality_args {
	char per_l_[PADL_(l_ulong)];
	l_ulong per;
	char per_r_[PADR_(l_ulong)];
};
...
struct linux_mq_timedsend_args {
	...
	char msg_prio_l_[PADL_(unsigned int)];
	unsigned int msg_prio;
	char msg_prio_r_[PADR_(unsigned int)];
...
int linux_rt_tsigqueueinfo(
    struct thread *, struct linux_rt_tsigqueueinfo_args *);
