...
#define	nosys	linux_nosys
	...
	"#17",			/* 17 = ; was linux_break */
	"#18",			/* 18 = ; was linux_stat */
	...
	"#26",			/* 26 = ptrace */
	"#27",			/* 27 = ; */
	"#28",			/* 28 = ; was linux_fstat */
	"linux_pause",			/* 29 = linux_pause */
	"#30",			/* 30 = ; */
	"#31",			/* 31 = ; was linux_stty */
	"#32",			/* 32 = ; was linux_getty */
	"linux_access",			/* 33 = linux_access */
	"linux_nice",			/* 34 = linux_nice */
	"#35",			/* 35 = ; was linux_ftime */
	"sync",			/* 36 = sync */
	...
	"#68",			/* 68 = ; was linux_sgetmask */
	"#69",			/* 69 = ; was linux_ssetmask */
	...
	"#109",			/* 109 = ; was linux_uname */
	"#110",			/* 110 = ; was linux_iopl */
	...
	"#166",			/* 166 = ; was linux_vm86 */
	"#167",			/* 167 = ; was linux_query_module */
	"poll",			/* 168 = poll */
	"#169",			/* 169 = ; was linux_nfsservctl */
	...
	"#254",			/* 254 = ; was set_thread_area */
	"#255",			/* 255 = ; was get_thread_area */
